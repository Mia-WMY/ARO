...
if __name__ == '__main__':
   ...
   #####################3
        ...
        print("cost 1200")
        # print("single low")
        # p = multiprocessing.Process(target=fun(fid='mid', train_num=1200, seed=seedx, epoch=800, bsize=20))
        # p.start()
        # print("single high")
        ...
        p.start()
        print('union 1:3')
        p = multiprocessing.Process(target=unfun(low_num=513, high_num=171, seed=seedx, epoch=800, bsize=20))
        p.start()
        print('union 1:4')

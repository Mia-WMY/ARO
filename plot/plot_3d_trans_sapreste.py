...
for i in range(20):
    ...
    fig, ax = plt.subplots(2, 5, figsize=(15, 8), frameon=False)
    ax[0,0].axis("off")
    ax[0, 1].axis("off")
    ax[0, 2].axis("off")
    ax[0, 3].axis("off")
    ...
    axes[1, 0].axis('off')
    axes[1, 1].axis('off')
    axes[0, 0].set_title(f"t=0", fontsize=16)
    axes[0, 1].set_title(f"t=2", fontsize=16)
    axes[0, 2].set_title(f"t=4", fontsize=16)
    axes[0, 3].set_title(f"t=6", fontsize=16)
    axes[0, 4].set_title(f"t=8", fontsize=16)

    axes[0, 0].text(-2, 10, "Ground Truth", fontsize=16, va='center', ha='center', rotation=90)
    axes[1, 0].text(-2, 10, "Predict", fontsize=16, va='center', ha='center', rotation=90)
    t=0
